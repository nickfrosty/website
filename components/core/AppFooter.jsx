...
export default function AppFooter() {
  return (
    <footer className="overflow-hidden pt-5 pb-8 mt-5 mb-2 w-full text-lg text-center text-gray-600 dark:text-gray-500">
      <div
        id="footer-divider"
        className="mx-auto mb-6 w-2/3 h-px bg-indigo-500 transform -rotate-1 md:w-1/3"
      ></div>

      <div className="items-center px-3 mx-auto space-y-3 max-w-md md:space-y-0 md:justify-between md:flex">
        <div className="">
          &copy;2021{" "}
          <Link href="/">
            <a
        ...
        <div className="flex justify-center space-x-6 text-gray-600 md:justify-between dark:text-gray-600">
          <a
