...
If you _need_ to transfer the database backup to a different server, like I did, you can securely download it using the "_secure copy_" command `scp` command from **your local computer**.
